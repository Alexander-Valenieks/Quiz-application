...
import com.game.quiz.dto.CategoriesDto;
import com.game.quiz.dto.CategoryQuestionCountInfoDto;
import com.game.quiz.dto.QuestionsDto;
import com.game.quiz.frontend.Difficulty;
import com.game.quiz.frontend.GameOptions;
...
public class QuizDataService {
    ...
    public List<QuestionsDto.QuestionDto> getQuizQuestions(GameOptions gameOptions) {
        ...
        if (availableQuestionCount >= gameOptions.getNumberOfQuestions()) {
            ...
            Map<Difficulty, Integer> eachDifficultyQuestionCount = calculateEachDifficultyQuestionCount(gameOptions.getNumberOfQuestions(), gameOptions.getDifficulty(), getCategoryQuestionCount(gameOptions.getCategoryId()));
